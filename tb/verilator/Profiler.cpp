...
uint32_t Profiler::get_inst_count() {
	//return inst_counter;
	return 0;
}
...
void Profiler::inc_inst_type(inst_t type, uint32_t cycles) {
	instructions[type]->increment(cycles);
}

inst_t Profiler::inst_decode(uint32_t inst) { 
...
uint32_t Profiler::get_opcode(uint32_t inst) {
	uint8_t mask = 0b1111111;
	return inst & mask;
} 
 
uint32_t Profiler::get_f3(uint32_t inst) {
	uint8_t mask = 0b111;
	return (inst>>12) & mask;
}

uint32_t Profiler::get_f7(uint32_t inst) {
	uint8_t mask = 0b1111111;
	return (inst>>25) & mask;
} 


inst_t Profiler::dec_R_TYPE(uint32_t inst) {
	uint32_t f3, f7;
	inst_t type = INVALID;
...
inst_t Profiler::dec_I_TYPE(uint32_t inst) {
	uint32_t f3, f7;
	inst_t type = INVALID;
...
inst_t Profiler::dec_I_L_TYPE(uint32_t inst) { // Decoding load instructions
	uint32_t f3;
	inst_t type = INVALID;
...
inst_t Profiler::dec_S_TYPE(uint32_t inst) {
	uint32_t f3;
	inst_t type = INVALID;
...
inst_t Profiler::dec_B_TYPE(uint32_t inst) {
	uint32_t f3, f7;
	inst_t type = INVALID;
...
inst_t Profiler::dec_SYSTEM_TYPE(uint32_t inst) {
	uint32_t f12;
	inst_t type = INVALID;
